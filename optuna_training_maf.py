...
def objective(trial):
    ...
    hidden_features = trial.suggest_categorical('hidden_features', [1, 5, 10, 20, 50])
    num_transforms = trial.suggest_categorical('num_transforms', [1, 5, 8, 10, 15, 30, 50])
...
if __name__ == '__main__':
    ...
    study_name = 'example_study_maf'  # Unique identifier of the study.
    storage_name = 'sqlite:///example_onlylog_maf.db'
