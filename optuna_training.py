...
def objective(trial):
    ...
    hidden_features = trial.suggest_categorical('hidden_features', [10, 20])
    num_transforms = trial.suggest_categorical('num_transforms', [1, 5, 6, 7, 8, 9, 10, 15, 30, 50])
...
if __name__ == '__main__':
    ...
    storage_name = 'sqlite:///example_onlylog_nsf_2.db'
